...
<div class="w-full px-3 my-2 text-[#004D9D]">
    <div class="py-12">
                            ...
                            <div class="flex items-start flex-1">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-gray-600 text-sm leading-tight">
                                        Gerencie o cadastro de usuários que acessam este sistema
                                    </p>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('profiles.index') }}" class="flex flex-col h-36 bg-white border border-gray-200 shadow-lg rounded-xl p-6 hover:shadow-2xl hover:border-[#004D9D]/20 transition-all duration-300 transform hover:-translate-y-1">
                            <div class="flex items-start flex-1">
                                ...
                                <div class="ml-4 flex-1">
                                    ...
                                    <p class="text-gray-600 text-sm leading-tight">
                                        Gerencie o cadastro de perfis no sistema
                                    </p>
                                </div>
                            </div>
                        </a>
