{{-- resources/views/livewire/sbar-report.blade.php - OPTIMIZED VERSION --}}
                ...
                <div class="font-montserrat relative">
                    ...
                    <div class="relative bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl shadow-xl overflow-hidden font-montserrat">
                        ...
                        <div class="bg-[#004D9D]/90 px-2 sm:px-3 lg:px-4 py-2 sm:py-2.5 lg:py-3 top-0 z-50 shadow-lg font-montserrat">
                            <div class="flex flex-col space-y-2 font-montserrat">
                                <div class="flex items-center justify-between font-montserrat">
                                    <h1 class="text-sm sm:text-base lg:text-2xl font-bold text-white font-montserrat">Sistema SBAR - Passagem de Plantão</h1>

                                    <div class="flex items-center space-x-2 font-montserrat">
                                        @if($lastRefresh)
                                            <span class="text-white/80 text-xs font-montserrat">
                                                Última atualização: {{ $lastRefresh }}
                                            </span>
                                        @endif

                                        <div x-show="autoRefreshEnabled"
                                                class="flex items-center space-x-1 bg-green-500/20 px-2 py-1 rounded-full font-montserrat">
                                            <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                                            <span class="text-green-200 text-xs font-medium font-montserrat">Auto-refresh</span>
                                            <span x-text="nextRefreshIn + 's'" class="text-green-200 text-xs font-montserrat"></span>
                                        </div>

                                        <button @click="toggleAutoRefresh()"
                                                class="inline-flex items-center justify-center px-2.5 py-1 rounded-md shadow-md font-medium transition text-xs focus:outline-none focus:ring-2 font-montserrat"
                                                ...
                                                x-text="autoRefreshEnabled ? 'Auto-refresh ON' : 'Auto-refresh OFF'"
                                                title="Atualização automática a cada 10 minutos">
                                        </button>
                                    </div>
                                </div>

                                {{-- Filters and Controls - Layout melhorado com gaps maiores --}}
                                <div class="w-full font-montserrat">
                                    <div class="flex flex-col lg:flex-row lg:items-end gap-6 lg:gap-8 font-montserrat">

                                        <!-- Filters Container - Centralizado com labels -->
                                        <div class="flex-1 min-w-0 font-montserrat">
                                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 lg:flex lg:flex-row lg:items-end gap-6 lg:gap-8 font-montserrat">
                                                ...
                                                <div class="flex flex-col items-center font-montserrat">
                                                    ...
                                                    <select
                                                        ...
                                                        class="appearance-none bg-white text-gray-700 border border-gray-300 rounded py-1 px-2 text-xs w-full min-w-[140px] focus:outline-none focus:ring-2 focus:ring-[#0071B9]/50 hover:border-[#0071B9]/30 transition-colors font-montserrat"
                                                    >
                                                ...
                                                <div class="flex flex-col items-center font-montserrat">
                                                    ...
                                                    <div class="flex w-full min-w-[140px]">
                                                        <select
                                        ...
                                        <!-- Action Buttons - Alinhados com os filtros -->
                                        <div class="flex items-center justify-center gap-4 flex-shrink-0 font-montserrat">
                                            <button
                        ...
                        <div id="patientsContainer" class="p-2 sm:p-3 lg:p-4 bg-white font-montserrat">
                            @if(isset($errorMessage) && $errorMessage)
                                <div class="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-lg mb-6 font-montserrat">
                                    <div class="flex items-center font-montserrat">
                                        ...
                                        <strong class="font-bold font-montserrat">Erro:</strong> <span class="ml-2 font-montserrat">{{ $errorMessage }}</span>
                                    </div>
                                </div>
                            ...
                            @else
                                {{-- Optimized Patient Cards Grid --}}
                                <div id="patientCardsContainer" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-2 sm:gap-3 lg:gap-4 font-montserrat">
