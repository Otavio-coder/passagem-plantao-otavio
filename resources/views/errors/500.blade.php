...
@section( 'content' )
    ...
    <h1 class="font-bold text-white text-9xl">500</h1>

    <div>
        <h6 class="text-2xl font-bold text-center text-gray-100 md:text-3xl">
            <span class="text-sky-900">Oops,</span> algo deu errado
        </h6>
        <p class="text-center text-gray-200 md:text-lg">
            Devido a um problema interno, essa página não pode ser exibida.
        </p>
    </div>
