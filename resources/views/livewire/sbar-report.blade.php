                ...
                <div class="bg-[#004D9D]/90 px-3 sm:px-4 lg:px-5 py-2 sm:py-3 lg:py-4 top-0 z-50 shadow-lg">
                    <div class="flex flex-col space-y-2 lg:space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-2 xl:gap-4 items-end">
                            ...
                            <!-- Buttons container -->
                            <div class="flex flex-row justify-center items-center gap-1 sm:gap-2 lg:gap-3 mt-3 mx-2">
                                <button
                                    wire:click="refreshData"
                                    wire:loading.attr="disabled"
                                    class="inline-flex items-center justify-center px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 rounded-md lg:rounded-lg text-white transition-all duration-200 bg-[#0071B9] hover:bg-[#004D9D] shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#0071B9]/40 disabled:opacity-50 text-xs sm:text-sm font-medium sm:font-semibold min-w-[40px] sm:min-w-[90px] whitespace-nowrap"
                                    title="Atualizar dados do setor selecionado"
                                >
                                    <span wire:loading.remove wire:target="refreshData" class="flex items-center">
                                        @svg('iconpark-updaterotation-o', 'w-4 h-4 sm:w-4 sm:h-4 lg:w-5 lg:h-5 flex-shrink-0 sm:mr-1.5')
                                        <span class="hidden sm:inline text-xs lg:text-sm">Atualizar</span>
                                    </span>
                                    <span wire:loading wire:target="refreshData" class="flex items-center">
                                        ...
                                        <span class="hidden sm:inline text-xs lg:text-sm">Atualizando...</span>
                                    </span>
                                </button>
                                ...
                                <button
                                    ...
                                    wire:loading.attr="disabled"
                                    class="inline-flex items-center justify-center px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 rounded-md lg:rounded-lg text-gray-700 bg-gray-100 border border-gray-300 transition-all duration-200 hover:bg-gray-200 hover:border-gray-400 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gray-400/40 disabled:opacity-50 text-xs sm:text-sm font-medium sm:font-semibold min-w-[40px] sm:min-w-[90px] whitespace-nowrap"
                                    title="Limpar todos os filtros aplicados"
                                >
                                    <span wire:loading.remove wire:target="resetFilters" class="flex items-center">
                                        @svg('eos-filter-alt-off', 'w-4 h-4 sm:w-4 sm:h-4 lg:w-5 lg:h-5 flex-shrink-0 sm:mr-1.5')
                                        <span class="hidden sm:inline text-xs lg:text-sm">Limpar</span>
                                    </span>
                                    <span wire:loading wire:target="resetFilters" class="flex items-center">
                                        ...
                                        <span class="hidden sm:inline text-xs lg:text-sm">Limpando...</span>
                                    </span>
                                </button>
                            </div>
                        </div>
                    ...
                    <div id="patientCardsContainer" class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">
                        @foreach($patients as $index => $patient)
                                <div wire:key="patient-{{ $patient->nr_atendimento }}" class="relative patient-card" x-data>
                                     <div
                                        class="cursor-pointer transform transition-all duration-300 hover:scale-105 relative"
