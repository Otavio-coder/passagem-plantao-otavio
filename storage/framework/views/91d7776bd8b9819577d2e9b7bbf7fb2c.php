        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
            ...
            <div>
                ...
                <div class="bg-gray-50 p-2 rounded-lg border transition-all duration-300"
                     <?php if(isset($patientDetails->diag) && !empty(trim($patientDetails->diag))): ?>
                ...
                >
                    ...
                    <p class="text-sm font-semibold text-gray-800">
                    <?php echo e(isset($patientDetails->diag) && !empty(trim($patientDetails->diag)) ? $patientDetails->diag : 'Não informado'); ?>
            ...
            <div>
                ...
                <!--[if BLOCK]><![endif]--><?php if(!$isPediatricPatient): ?>
                    ...
                    ?>
                    <div class="<?php echo e($mewsStyling['bg']); ?> p-2 rounded-lg border <?php echo e($mewsStyling['border']); ?> relative">
                ...
                <?php else: ?>
                    ...
                    ?>
                    <div class="<?php echo e($pewsStyling['bg']); ?> p-2 rounded-lg border <?php echo e($pewsStyling['border']); ?> relative">
                    <label class="block text-xs font-bold text-gray-600 mb-0.5 flex items-center">
                ...
                ?>
                <div class="<?php echo e($bradenStyling['bg']); ?> p-2 rounded-lg border <?php echo e($bradenStyling['border']); ?> relative">
                    <label class="block text-xs font-bold text-gray-600 mb-0.5 flex items-center">
                ...
                ?>
                <div class="<?php echo e($morseStyling['bg']); ?> p-2 rounded-lg border <?php echo e($morseStyling['border']); ?> relative">
                    <label class="block text-xs font-bold text-gray-600 mb-0.5 flex items-center">
                ...
                ?>
                <div class="<?php echo e($dorStyling['bg']); ?> p-2 rounded-lg border <?php echo e($dorStyling['border']); ?> relative">
                    <label class="block text-xs font-bold text-gray-600 mb-0.5 flex items-center">
                    Dor (Pain Scale):
                ...
                ?>
                <div class="<?php echo e($tevStyling['bg']); ?> p-2 rounded-lg border <?php echo e($tevStyling['border']); ?> relative">
                    <label class="block text-xs font-bold text-gray-600 mb-0.5 flex items-center">
