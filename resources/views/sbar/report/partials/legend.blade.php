<div
    x-data="{ open: false }"
    @open-sbar-legend.window="open = true; document.body.style.overflow = 'hidden'"
    x-show="open"
    x-cloak
    style="display: none;"
>
    <div class="fixed inset-0 z-[9999]">
        ...
        <div class="absolute inset-0 flex items-center justify-center p-0 sm:p-4">
            <div
                class="relative bg-white flex flex-col overflow-hidden w-full h-full sm:w-[95vw] sm:h-[92vh] sm:rounded-2xl lg:w-[90vw] lg:h-[90vh] lg:max-w-[1500px] shadow-2xl"
                @click.stop
                x-show="open"
            ...
            >
                <div class="flex-shrink-0 bg-[#004D9D] px-4 sm:px-6 py-3 sm:py-4 border-b border-white/20">
                    <div class="flex items-start justify-between gap-3 min-w-0">
                        <div class="min-w-0">
                            <h2 class="text-white text-lg sm:text-xl font-bold font-montserrat">Legenda do Sistema SBAR</h2>
                            <p class="text-blue-100 text-xs sm:text-sm mt-0.5">Mesmo conteúdo e formatação da legenda anterior, agora em modal.</p>
                        </div>
                        <button
                            type="button"
                            class="inline-flex items-center justify-center w-9 h-9 rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors"
                ...
                <div class="flex-1 min-h-0 overflow-y-auto bg-white px-3 sm:px-4 pb-4 sm:pb-5 font-montserrat">
                            ...
                            <div>
                                ...
                                <div class="space-y-2 text-xs">
                                    ...
                                    <div class="space-y-2 text-xs">
                                        ...
                                        <p class="text-[11px] text-gray-700"><span class="font-semibold">Cirurgia</span> - Agenda ativa futura e ainda não executada</p>
                                        <p class="text-[11px] text-gray-700"><span class="font-semibold">Hemoterapia</span> - Programação ativa sem finalização</p>
