    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-16">
        ...
        @php
          ...
          // Meus Setores - sempre aparece
          $cards[] = [
              'title' => 'Meus Setores',
              'description' => 'Configure os setores de internação que você deseja visualizar',
              'href' => route('user.preferences.index'),
...
{{-- Modal de Seleção de Setores (aparece apenas na home para novos usuários) --}}
@auth
