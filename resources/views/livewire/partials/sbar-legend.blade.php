                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-colors">
                                <button type="button" class="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center shadow-lg" aria-label="Alta efetivada">
                            ...
                            <div class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 transition-colors">
                                <button type="button" class="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center shadow-lg" aria-label="Alta médica">
                    ...
                    <div>
                        ...
                        {{-- Previsão de Alta --}}
                        <h4 class="text-xs font-semibold text-gray-600 mt-4 mb-2">Previsão de Alta</h4>
                        <div class="space-y-1.5 text-xs text-gray-700 pl-2">
                            <p>(busca último registro dos últimos 10 dias na tabela de previsão de alta)</p>
                            <p>• Exibe apenas se não houver Alta Médica ou Efetivada</p>
                            <p>• Mostra no formato: <strong>Prev.Alta: DD/MM/YYYY</strong></p>
                        </div>
                    </div>
                        ...
                        <div class="space-y-2 text-xs">
                            ...
                            <div class="grid grid-cols-2 gap-1.5">
                                <div class="flex items-center gap-2 p-1.5 rounded hover:bg-gray-100">
                                    <img src="{{ asset('images/icons/patient-card/alert.svg') }}" class="w-5 h-5" alt="Óbito" />
                                    <span class="font-semibold text-gray-800">Óbito registrado</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded hover:bg-gray-100">
                                    <img src="{{ asset('images/icons/patient-card/alta.svg') }}" class="w-5 h-5" alt="Alta" />
                                ...
                                <div class="flex items-center gap-2 p-1.5 rounded hover:bg-gray-100">
                                    ...
                                    <span class="text-[10px] text-gray-500">(solicitado/coletado/agendado - TC, RM, etc.)</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded hover:bg-gray-100">
                                    ...
                                    <span class="text-[10px] text-gray-500">(agendada)</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded hover:bg-gray-100">
                                ...
                                <div class="flex items-center gap-2 p-1.5 rounded hover:bg-gray-100">
                                    ...
                                    <span class="text-[10px] text-gray-500">(ativo na prescrição)</span>
                                </div>
                            </div>

                            {{-- Cores da Próxima Pendência --}}
                            <p class="text-[10px] font-semibold text-gray-500 uppercase tracking-wide mt-4 mb-2">Cores da Próxima Pendência</p>
                            <div class="grid grid-cols-2 gap-1 text-xs">
                                <div class="flex items-center gap-2 p-1.5 rounded">
                                    <span class="w-3 h-3 rounded-sm flex-shrink-0 bg-purple-200 border border-purple-400"></span>
                                    <span class="text-gray-700">Cirurgia agendada</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded">
                                    <span class="w-3 h-3 rounded-sm flex-shrink-0 bg-red-200 border border-red-400"></span>
                                    <span class="text-gray-700">Hemoterapia / Alta / Óbito</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded">
                                    <span class="w-3 h-3 rounded-sm flex-shrink-0 bg-blue-200 border border-blue-400"></span>
                                    <span class="text-gray-700">Exame / Alta Médica</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded">
                                    <span class="w-3 h-3 rounded-sm flex-shrink-0 bg-pink-200 border border-pink-400"></span>
                                    <span class="text-gray-700">Quimioterapia</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded">
                                    <span class="w-3 h-3 rounded-sm flex-shrink-0 bg-emerald-200 border border-emerald-400"></span>
                                    <span class="text-gray-700">Antimicrobiano ativo</span>
                                </div>
                                <div class="flex items-center gap-2 p-1.5 rounded">
                                    <span class="w-3 h-3 rounded-sm flex-shrink-0 bg-orange-200 border border-orange-400"></span>
                                    <span class="text-gray-700">Previsão de Alta</span>
                                </div>
                            </div>
                        </div>
                    </div>
