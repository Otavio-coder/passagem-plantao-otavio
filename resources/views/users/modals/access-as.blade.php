...
">
    ...
    >
        {{-- Backdrop --}}
        <div class="absolute inset-0 bg-black/60 backdrop-blur-sm" onclick="closeModal('modal-access-as')"></div>
        ...
        <div class="absolute inset-0 flex items-center justify-center p-0 sm:p-4">
            ...
            >
                ...
                <div class="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-[#004D9D] to-[#0071B9] flex-shrink-0">
                    ...
                    <button onclick="closeModal('modal-access-as')" class="p-2 text-white/70 hover:text-white hover:bg-white/15 rounded-lg transition-colors">
                ...
                {{-- Content --}}
                <form id="form-modal-access-as" action="{{ route('users.access.as') }}" method="post" class="p-4">
                    @csrf
                ...
                <div class="px-4 py-3 border-t border-gray-200 bg-gray-100 flex-shrink-0 flex justify-end gap-3">
                    <button
                        type="button"
                        onclick="closeModal('modal-access-as')"
