    ...
    */
    ...
    'connections' => [
        ...
        'tasy' => [
            ...
            'port' => '1521',
            'database' => env('DB_TASY_SERVICE_NAME'),
            'service_name' => env('DB_TASY_SERVICE_NAME'),
            'username' => env('DB_TASY_USERNAME'),
            'password' => env('DB_TASY_PASSWORD'),
            'charset' => 'AL32UTF8',
            'prefix' => '',
        ],
        ...
        'scola' => [
            ...
            'host' => env('SCOLA_HOST'),
            'port' => '1521',
            'database' => env('SCOLA_SERVICE'),
            'service_name' => env('SCOLA_SERVICE'),
            'username' => env('SCOLA_USER'),
            'password' => env('SCOLA_PASS'),
            'charset' => 'AL32UTF8',
            'prefix' => '',
        ],
