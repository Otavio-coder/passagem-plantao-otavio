        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex-shrink-0 flex items-center">
                    <img class="block lg:hidden h-12 w-auto" src="<?php echo e(asset('images/santacasa-horizontal-branco.svg')); ?>" alt="">
                    <img class="hidden lg:block h-12 w-auto" src="<?php echo e(asset('images/santacasa-horizontal-branco.svg')); ?>" alt="">
                </div>

                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        <a href="<?php echo e(route( 'home' )); ?>" class="transition duration-200 ease-in-out border-b-4 hover:border-blue-200 text-white hover:text-blue-200 px-3 py-2 text-sm font-medium">Inicio</a>
                        <a href="<?php echo e(route('feedback')); ?>" class="transition duration-200 ease-in-out border-b-4 hover:border-blue-200 text-white hover:text-blue-200 px-3 py-2 text-sm font-medium">
                            Feedback
                        </a>
                    </div>
                </div>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any( ['ver usuarios','ver perfis','ver logs','configurar sistema'] )): ?>
                    <div class="relative">
                        <div class="hidden sm:block sm:ml-6">
                            <div class="flex space-x-4">
                        ...
                        <div class="origin-top-left absolute left-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10 hidden menu" role="menu" aria-orientation="vertical" aria-labelledby="admin-menu" id="admin-menu">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check( 'ver usuarios' )): ?>
                                <a href="<?php echo e(route( 'users.index' )); ?>" class="text-gray-600 hover:text-gray-800 hover:bg-blue-100 px-3 py-4 lg:py-2 flex items-center text-xs rounded" role="menuitem">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check( 'ver perfis' )): ?>
                                <a href="<?php echo e(route( 'profiles.index' )); ?>" class="text-gray-600 hover:text-gray-800 hover:bg-blue-100 px-3 py-4 lg:py-2 flex items-center text-xs rounded" role="menuitem">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configurar sistema')): ?>
                                <a href="<?php echo e(route('system-configuration.index')); ?>" class="text-gray-600 hover:text-gray-800 hover:bg-blue-100 px-3 py-4 lg:py-2 flex items-center text-xs rounded" role="menuitem">
                                    ...
                                    <p class="ml-3 text-sm">Configurações</p>
                                </a>
                            <?php endif; ?>

                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('configurar sistema')): ?>
                                <a href="<?php echo e(route('chat-auditoria')); ?>" class="text-gray-600 hover:text-gray-800 hover:bg-blue-100 px-3 py-4 lg:py-2 flex items-center text-xs rounded" role="menuitem">
                                    <svg class="w-5 h-5 text-sky-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check( 'ver logs' )): ?>
                                <a href="<?php echo e(route( 'logs' )); ?>" target="_blank" class="text-gray-600 hover:text-gray-800 hover:bg-blue-100 px-3 py-4 lg:py-2 flex items-center text-xs rounded" role="menuitem">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <span class="hidden md:block text-white font-medium">Olá, <?php echo e(auth()->user()->name); ?></span>
                ...
                <div class="ml-3 relative">
                        ...
                        <button type="button" class="sm:hidden max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none" id="user-menu" aria-expanded="false" aria-haspopup="true" onclick="toggleNavbar('profile-menu')">
                            <div class="flex items-center justify-center text-white rounded-full h-10 w-10">
                                <?php if( auth()->user()->photo() ): ?>
                                    <img class="h-10 w-10 rounded-full" src="data:image/png;base64,<?php echo e(auth()->user()->photo()); ?>" alt="">
                                <?php else: ?>
                    ...
                    <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-10 hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu" id="user-options">
                        ...
                        <span class="md:hidden text-gray-600 text-xs font-medium px-3">Olá, <?php echo e(strtok(auth()->user()->name, " ")); ?></span>
...
<?php /**PATH /var/www/passagem-plantao/resources/views/partials/navbar.blade.php ENDPATH**/ ?>