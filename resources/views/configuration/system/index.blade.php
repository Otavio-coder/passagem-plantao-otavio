...
<div class="w-full px-3 my-2 text-gray-600">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('home') }}"
           class="inline-flex justify-center items-center px-3 py-2 text-santacasa-100 hover:text-santacasa-200 transition text-sm font-medium">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200">
        ...
        <form method="POST" action="{{ route('user.preferences.update') }}">
            ...
            {{-- Lista de Hospitais --}}
            <div class="p-4 overflow-y-auto" style="max-height: max(500px, calc(100svh - 260px))">
                @php
                    $hospitalColors = [
